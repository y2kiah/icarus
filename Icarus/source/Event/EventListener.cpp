...
EventManagerWeakPtr	EventListener::s_eventMgr;
...
-----------------------------------------------------------------------------*/
bool EventListener::registerEventHandler(const string &eventType, const IEventHandlerPtr &handler, uint32_t priority)
{
	...
	EventManagerPtr eventMgr(s_eventMgr.lock());
